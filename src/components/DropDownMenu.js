...
export default function DropDownMenu({setItem}){
    ...
    data = ['Problema de Energia', 'Problema de iluminação', 'Buraco', 'Problemas naturais', 'Esgoto', 'Lixo', 'Bueiro', 'Problema em Construções'];
    icons = [pinEletrica, pinIluminacao, pinBuraco, pinProblemasNaturais, pinEsgoto, pinLixo, pinBueiro, pinConstrucao]
    ...
    return (
        <SelectDropdown
            ...
            renderCustomizedRowChild={(item, index) => {return(
                <>
                    <Image source={icons[index]} style={{width: 20, height: 23}}></Image>
